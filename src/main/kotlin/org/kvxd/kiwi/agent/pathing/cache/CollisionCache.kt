package org.kvxd.kiwi.agent.pathing.cache
...
object CollisionCache {
    ...
    fun isLiquid(pos: BlockPos) = hasState(pos, WATER, LAVA)

    fun hasAdjacentLiquid(pos: BlockPos): Boolean {
        for (dir in Direction.entries) {
            if (isLiquid(pos.relative(dir))) return true
        }
        return false
    }

    fun isSafeToMine(pos: BlockPos) = hasState(pos, SOLID) && !hasAdjacentLiquid(pos)
    ...
    fun isLeaf(pos: BlockPos): Boolean {
